    ...
    'accordion' => [
        ...
        'key_stats' => [
            ...
            'content' => [
                ...
                'Moins de 10 % des patients atteints de troubles mentaux en Afrique reçoivent un traitement approprié.',
            ],
        ],
        'why_lmics' => [
            ...
            'content' => [
                [
                    ...
                    'description' => 'Manque d’accès aux soins de base et charge croissante des maladies chroniques.',
                ],
                [
                    'title' => 'Potentiel d’Innovation',
                    'description' => 'Adoption rapide de solutions numériques telles que la télémédecine et les objets connectés.',
                ],
                [
                    'title' => 'Impact Mondial',
                    'description' => 'Améliorer la santé de milliards de personnes et réduire les inégalités en matière de santé.',
                ],
            ],
        ],
        'examples' => [
            ...
            'content' => '
                ...
                <strong>Asie :</strong> Afghanistan, Népal, Yémen (Revenu faible). <br>
                ...
                <strong>Amérique Latine et Caraïbes :</strong> Haïti (souvent revenu faible). <br>
                Honduras, Nicaragua, Paraguay, Salvador (Revenu intermédiaire inférieur). <br>
                Brésil, Colombie, Mexique, Pérou, République Dominicaine (Revenu intermédiaire supérieur).
            ',
        ],
    ],
    'actions' => [
        ...
        'buttons' => [
            'startup' => [
                'text' => 'Startup',
                'title' => 'Rejoindre notre accélérateur ou incubateur',
            ],
            'mentor' => [
                'text' => 'Devenir Mentor',
