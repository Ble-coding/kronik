...
<body>
    ...
    <main>
        <!-- prettier-ignore -->
        <?php
                require __DIR__ . '/layouts/about/slide.php';
            ?>
  

         <!--Home 5 Section 4 -->
         <?php
                require __DIR__ . '/layouts/about/about.php';
         ?>

        <?php
                require __DIR__ . '/layouts/about/team.php';
         ?>


        <?php
                require __DIR__ . '/layouts/about/partner.php';
         ?>
