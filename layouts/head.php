    <!-- Favicon icon-->
    <link rel="icon" href="/assets/favicon_logo.png" type="image/x-icon">
     <link rel="shortcut icon" href="/assets/favicon_logo.png" type="image/x-icon">
   <link rel="icon" type="image/x-icon" href="/assets/favicon_logo.png?v=2" />
