    ...
    <div class="container" data-aos="fade-up">
        ...
        <div class="row align-items-end">
            <div class="col-lg-7 mb-30">
                <div class="banner-small-title-black">Modules de formation</div>
            ...
            <div class="col-lg-5 mb-30">
                <p class="mb-20 paragraph-rubik-r">
                    Nos formations sont conçues pour équiper les startups et innovateurs 
                    des compétences nécessaires pour développer des solutions impactantes 
        ...
        <div class="box-services-lists mt-3" data-aos="fade-up">
            <div class="service-left">
                <div class="service-item-list" role="tablist">
                    ...
                    <!-- Module 1 -->
                    <a href="#module-1" class="item-service" data-bs-toggle="tab" type="button" role="tab" aria-controls="module-1" aria-selected="true">
                        <span class="title-service">Module 1 : Introduction à la Santé Numérique et aux LMICs</span>
