               ...
               <div class="tab-pane fade show active service-detail" id="pills-mentorat" role="tabpanel" aria-labelledby="pills-mentorat-tab">
                 <div class="box-questions">
                   ...
                   <div class="service-detail">
                     ...
                     <p class="p-classik"> Les mentors jouent un rôle essentiel en veillant à l’ <strong>adéquation des solutions aux besoins concrets</strong> et en accompagnant les équipes dans un environnement contrôlé, comme celui des <strong>hôpitaux partenaires</strong>. Grâce à cette collaboration, chaque innovation peut être testée, améliorée et ajustée en fonction des retours des professionnels de santé et des utilisateurs finaux, garantissant ainsi une efficacité maximale et un impact durable. </p>
                     <h3>Principaux Avantages d’Être Mentor au Kronik X Health</h3>
                     <div class="row">
                       <div class="col-md-6">
                         <ul>
                           <li>Accompagnement de startups prometteuses dans le domaine de la santé.</li>
                           <li>Contributions directes à des projets à fort impact social et médical.</li>
                           <li>Tests des solutions en conditions réelles avec des hôpitaux partenaires.</li>
                           <li>Adaptation des solutions aux réalités locales pour maximiser leur utilité.</li>
                           <li>Encouragement à l’utilisation de technologies connectées pour améliorer les soins.</li>
                         </ul>
                       </div>
                       <div class="col-md-6">
                         <ul>
                           <li>Réduction des complications liées aux maladies chroniques grâce à l’innovation.</li>
                           <li>Optimisation de l’accès aux soins dans les zones sous-équipées.</li>
                           <li>Amélioration de l’adhérence des patients aux traitements via des outils numériques.</li>
                           <li>Renforcement de la collaboration entre patients, médecins et startups.</li>
                           <li>Validation et déploiement de solutions à forte valeur ajoutée dans le secteur de la santé.</li>
                         </ul>
                       </div>
                     </div>
                   </div>
                       ...
                       <div id="accordionFAQ" class="accordion">
                         ...
                         <div class="accordion-item wow fadeInUp">
                           <h5 class="accordion-header" id="headingWhyMentor">
                             <button class="accordion-button text-heading-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseWhyMentor" aria-expanded="true" aria-controls="collapseWhyMentor"> Pourquoi devenir mentor ? </button>
                           </h5>
                           <div class="accordion-collapse collapse" id="collapseWhyMentor" aria-labelledby="headingWhyMentor" data-bs-parent="#accordionFAQ">
                             <div class="accordion-body">
                               <ul>
                                 <li>
                                   <strong>Contribuez à un impact social :</strong> Aidez à transformer la vie des patients atteints de maladies chroniques grâce à des solutions innovantes.
                                 </li>
                                 <li>
                                   <strong>Partagez votre expertise :</strong> Mettez vos compétences et votre expérience au service de projets prometteurs.
                                 </li>
                                 <li>
                                   <strong>Rejoignez un réseau influent :</strong> Collaborez avec des experts en santé, technologies et entrepreneuriat.
                                 </li>
                                 <li>
                                   <strong>Apprenez et grandissez :</strong> Découvrez de nouvelles approches, technologies et perspectives en travaillant avec des innovateurs talentueux.
                                 </li>
                               </ul>
                             </div>
                           </div>
                         ...
                         <div class="accordion-item wow fadeInUp">
                           <h5 class="accordion-header" id="headingMentorProfile">
                             <button class="accordion-button text-heading-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseMentorProfile" aria-expanded="true" aria-controls="collapseMentorProfile"> Profil des mentors recherchés </button>
                           </h5>
                           <div class="accordion-collapse collapse" id="collapseMentorProfile" aria-labelledby="headingMentorProfile" data-bs-parent="#accordionFAQ">
                             <div class="accordion-body">
                               <ul>
                                 <li>
                                   <strong>Santé et médecine :</strong> Oncologie, maladies chroniques (diabète, hypertension, etc.), gestion des patients.
                                 </li>
                                 <li>
                                   <strong>Technologie :</strong> Intelligence artificielle, Big Data, santé numérique, objets connectés.
                                 </li>
                                 <li>
                                   <strong>Entrepreneuriat et innovation :</strong> Développement de startups, modèles économiques, stratégies de croissance.
                                 </li>
                                 <li>
                                   <strong>Réglementation :</strong> Connaissances des politiques de santé et de la réglementation numérique en Afrique.
                                 </li>
                               </ul>
                             </div>
                           </div>
                         ...
                         <div class="accordion-item wow fadeInUp">
                           <h5 class="accordion-header" id="headingRoles">
                             <button class="accordion-button text-heading-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseRoles" aria-expanded="true" aria-controls="collapseRoles"> Rôles et responsabilités des mentors </button>
                           </h5>
                           <div class="accordion-collapse collapse " id="collapseRoles" aria-labelledby="headingRoles" data-bs-parent="#accordionFAQ">
                             <div class="accordion-body">
                               <ul>
                                 <li>Accompagner les startups sur les stratégies de développement, commercialisation et mise à l’échelle.</li>
                                 <li>Participer à des sessions de coaching et organiser des ateliers pratiques.</li>
                                 <li>Partager votre réseau pour connecter les projets incubés à des partenaires stratégiques.</li>
                                 <li>Évaluer les progrès des projets et orienter les équipes vers des solutions concrètes.</li>
                               </ul>
                             </div>
                           </div>
                         </div>
                         ...
                         <div class="accordion-item wow fadeInUp">
                           ...
                           <div class="accordion-collapse collapse" id="collapseCommitment" aria-labelledby="headingCommitment" data-bs-parent="#accordionFAQ">
                             <div class="accordion-body">
                               <ul>
                                 <li>
                                   <strong>Durée :</strong> 6 mois minimum, avec un accompagnement flexible selon vos disponibilités.
                                 </li>
                                 <li>
                                   <strong>Interactions :</strong> Une à deux sessions par mois, en ligne ou en présentiel.
                                 </li>
                                 <li>
                                   <strong>Soutien :</strong> Accès à des ressources et outils du Kronik X Health pour faciliter votre mission de mentorat.
                                 </li>
                               </ul>
                             </div>
                           </div>
                         ...
                         <div class="accordion-item wow fadeInUp">
                           <h5 class="accordion-header" id="headingBenefits">
                             <button class="accordion-button text-heading-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBenefits" aria-expanded="true" aria-controls="collapseBenefits"> Avantages pour les mentors </button>
                           </h5>
                           <div class="accordion-collapse collapse" id="collapseBenefits" aria-labelledby="headingBenefits" data-bs-parent="#accordionFAQ">
                             <div class="accordion-body">
                               <ul>
                                 <li>
                                   <strong>Reconnaissance :</strong> Votre contribution sera valorisée sur nos plateformes et lors de nos événements.
                                 </li>
                                 <li>
                                   <strong>Réseautage :</strong> Accès à une communauté de professionnels et d’experts internationaux.
                                 </li>
                                 <li>
                                   <strong>Développement personnel :</strong> Enrichissez votre expérience en accompagnant des projets innovants.
                                 </li>
                               </ul>
                             </div>
                           </div>
                         ...
                         <div class="accordion-item wow fadeInUp">
                           <h5 class="accordion-header" id="headingBecomeMentor">
                             <button class="accordion-button text-heading-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseBecomeMentor" aria-expanded="true" aria-controls="collapseBecomeMentor">
                               <p>Comment devenir mentor ?</p>
                             </button>
                           </h5>
                           <div class="accordion-collapse collapse" id="collapseBecomeMentor" aria-labelledby="headingBecomeMentor" data-bs-parent="#accordionFAQ">
                             <div class="accordion-body">
                               <h6 class="mb-3">Suivez ces étapes pour rejoindre notre réseau de mentors :</h6>
                               <ol>
                                 <li>
                                   <strong>Remplir le formulaire :</strong> Accédez au formulaire en ligne via le lien ci-dessous.
                                 </li>
                                 <li>
                                   <strong>Entretien :</strong> Une fois votre candidature reçue, nous vous contacterons pour un entretien.
                                 </li>
                                 <li>
                                   <strong>Intégration :</strong> Après validation, vous serez intégré(e) à notre réseau de mentors.
                                 </li>
                               </ol>
                             </div>
                           </div>
                           ...
                           <div class="accordion-collapse collapse" id="collapseContactInfo" aria-labelledby="headingContactInfo" data-bs-parent="#accordionFAQ">
                             <div class="accordion-body">
                               ...
                               <ul>
                                 <li>
                                   <strong>Email :</strong>
                                   <a href="mailto:mentors@kronikxhealth.ci">mentors@kronikxhealth.ci</a>
                                 </li>
                                 <li>
