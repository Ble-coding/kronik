         ...
         <div class="row">
           <div class="col-lg-3">
             ...
             <div class="sidebar-brochure">
               <h4 class="sub-heading-ag-xl title-line-bottom">Brochures</h4>
               <p class="paragraph-rubik-m">Cliquez sur les liens ci-dessous pour télécharger les brochures.</p>
               ...
               <a href="documents/document.pdf" download="MonDocumentPDF">
                ...
                <a href="documents/document.doc" download="MonDocumentDOC">
                   ...
                   </svg> DOC. Télécharger  </a>
               </div>
             </div>
               <ul class="nav nav-pills flex-column" id="pills-tab" role="tablist">
                 <li class="nav-item" role="presentation">
                   <a class="nav-link active" id="pills-acceleration-tab" data-bs-toggle="pill" href="#pills-acceleration" role="tab" aria-controls="pills-acceleration" aria-selected="true">
                     <span>Acceleration et Incubations</span>
                 ...
                 <li class="nav-item" role="presentation">
                   <a class="nav-link" id="pills-projet-tab" data-bs-toggle="pill" href="#pills-projet" role="tab" aria-controls="pills-projet" aria-selected="false">
                     <span>Projets Pilotes</span>
                     <svg width="21" height="12" viewBox="0 0 21 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                       <path d="M20.2742 6.67971H0.724078C0.323572 6.67971 0 6.37442 0 5.99653C0 5.61864 0.323572 5.31335 0.724078 5.31335H18.5251L14.1308 1.16728C13.848 0.900413 13.848 0.467019 14.1308 0.200151C14.4137 -0.0667171 14.873 -0.0667171 15.1558 0.200151L20.7878 5.51403C20.996 5.71045 21.0571 6.00293 20.9439 6.25913C20.8308 6.51319 20.5661 6.67971 20.2742 6.67971Z" fill="" />
                       <path d="M14.6354 12C14.4499 12 14.2643 11.9338 14.124 11.7993C13.8412 11.5324 13.8412 11.0991 14.124 10.8322L19.7628 5.5119C20.0456 5.24503 20.505 5.24503 20.7878 5.5119C21.0706 5.77877 21.0706 6.21216 20.7878 6.47903L15.1491 11.7993C15.0065 11.9338 14.821 12 14.6354 12Z" fill="" />
                     </svg>
                 ...
                 <li class="nav-item" role="presentation">
                   <a class="nav-link" id="pills-formation-tab" data-bs-toggle="pill" href="#pills-formation" role="tab" aria-controls="pills-formation" aria-selected="false">
                     <span>Formation et Ressources</span>
                     <svg width="21" height="12" viewBox="0 0 21 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                       <path d="M20.2742 6.67971H0.724078C0.323572 6.67971 0 6.37442 0 5.99653C0 5.61864 0.323572 5.31335 0.724078 5.31335H18.5251L14.1308 1.16728C13.848 0.900413 13.848 0.467019 14.1308 0.200151C14.4137 -0.0667171 14.873 -0.0667171 15.1558 0.200151L20.7878 5.51403C20.996 5.71045 21.0571 6.00293 20.9439 6.25913C20.8308 6.51319 20.5661 6.67971 20.2742 6.67971Z" fill="" />
                       <path d="M14.6354 12C14.4499 12 14.2643 11.9338 14.124 11.7993C13.8412 11.5324 13.8412 11.0991 14.124 10.8322L19.7628 5.5119C20.0456 5.24503 20.505 5.24503 20.7878 5.5119C21.0706 5.77877 21.0706 6.21216 20.7878 6.47903L15.1491 11.7993C15.0065 11.9338 14.821 12 14.6354 12Z" fill="" />
                     </svg>
             ...
             <!-- <div class="sidebar-brochure">
               <h4 class="sub-heading-ag-xl title-line-bottom">Get a Free Quote</h4>
               <div class="form-quote mt-4">
                 <form class="form" action="#">
                   ...
                   <div class="form-group">
                     <button type="submit" class="btn btn-primary-home-rounded w-100">Send Message</button>
                   </div>
                 </form>
               </div>
             </div> -->
           ...
           <div class="col-lg-9">
             <div class="tab-content" id="pills-tabContent">
               <div class="tab-pane fade show active service-detail" id="pills-acceleration" role="tabpanel" aria-labelledby="pills-acceleration-tab">
                 <!-- <div class="service-detail"><h1 class="heading-ag-3xl mb-20">Acceleration et Incubations</h1><p>Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis.</p><p>Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis. Augue eu vulputate tortor egestas cursus vivamus. Commodo dictum iaculis eget massa phasellus ultrices nunc dignissim. Id nulla amet tincidunt urna sed massa sed. Pellentesque imperdiet proin aliquam nisl nulla. In donec massa ultrices amet eget. Tristique sed purus et maecenas condimentu purus lectus diam diam tellus libero id sapien justo.</p><p>Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis. Augue eu vulputate egestas cursus vivamus. Commodo dictum iaculis eget massa phasellus ultrices nunc dignissim.</p><h3>Plan Benefits</h3><div class="row"><div class="col-md-6"><ul><li>Global Data Analysis</li><li>Zero broker commission</li><li>Analytics and Engineering</li><li>IT Services & Cybersecurity</li><li>Data and Cloud Computing</li></ul></div><div class="col-md-6"><ul><li>Guaranteed by the services</li><li>Workspace cloud business</li><li>Managed backup services</li><li>Experts & News from the Industry.</li><li>A well established expertise</li></ul></div></div></div> -->
                 <div class="box-questions">
                   <!-- <h1 class="heading-ag-3xl mb-20"></h1> -->
                   <h4 class="heading-ag-lg dark-950 mb-30">Acceleration et Incubations</h4>
                   <div>
                     <img src="assets/imgs/pages/services/baner_4.jpg" alt="Kronik" />
                   </div>
                   <div class="block-faqs">
                     <div class="accordion" id="accordionFAQ">
                       <!-- Premier accordéon (Incubation) actif par défaut -->
                       <div class="accordion-item wow fadeInUp">
                         <h5 class="accordion-header" id="headingIncubation">
                           <button class="accordion-button text-heading-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseIncubation" aria-expanded="false" aria-controls="collapseIncubation">
                             <p>Incubation : Incubateur Kronik-X Lab</p>
                           </button>
                         </h5>
                         <div class="accordion-collapse collapse" id="collapseIncubation" aria-labelledby="headingIncubation" data-bs-parent="#accordionFAQ">
                           <div class="accordion-body">
                             <h6 class="mb-3">Donnez vie à vos idées et posez les bases de solutions innovantes en santé numérique.</h6>
                             <h4>Objectif Principal :</h4>
                             <p class="p-classik"> L’incubateur Kronik-X Lab soutient les startups en phase d’idéation ou au stade précoce dans le développement de solutions adaptées aux défis des maladies chroniques dans les LMICs. </p>
                             <h4>Public Cible :</h4>
                             <ul>
                               <li>Startups en phase d’idéation ou au stade précoce.</li>
                               <li>Innovateurs souhaitant valider leurs concepts ou prototypes.</li>
                               <li>Équipes cherchant un accompagnement structuré.</li>
                             </ul>
                             <h4>Contenu du Programme :</h4>
                             <ol>
                               <li>Modules axés sur : <ul>
                                   <li>Introduction à la santé numérique.</li>
                                   <li>Design Thinking et prototypage.</li>
                                   <li>Réglementation et éthique.</li>
                                   <li>Modèle économique et stratégie de financement.</li>
                                 </ul>
                               </li>
                               <li>Accès à des mentors experts et ressources techniques.</li>
                               <li>Formation continue et accompagnement personnalisé.</li>
                             </ol>
                             <h4>Durée :</h4>
                             <p class="p-classik">6 à 12 mois.</p>
                           </div>
                         </div>
                       </div>
                       <!-- Deuxième accordéon (Accélération) désactivé par défaut -->
                       <div class="accordion-item wow fadeInUp">
                         <h5 class="accordion-header" id="headingAcceleration">
                           <button class="accordion-button text-heading-5 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseAcceleration" aria-expanded="false" aria-controls="collapseAcceleration">
                             <p>Accélération : Accélérateur Kronik-X Growth</p>
                           </button>
                         </h5>
                         <div class="accordion-collapse collapse" id="collapseAcceleration" aria-labelledby="headingAcceleration" data-bs-parent="#accordionFAQ">
                           <div class="accordion-body">
                             <h6 class="mb-3">Accélérez votre croissance et maximisez votre impact.</h6>
                             <h4>Objectif Principal :</h4>
                             <p class="p-classik"> L’accélérateur Kronik-X Growth aide les startups matures à franchir un cap décisif en structurant leur croissance, en les connectant à des investisseurs et en optimisant leurs solutions pour les marchés locaux et internationaux. </p>
                             <h4>Public Cible :</h4>
                             <ul>
                               <li>Startups avec un produit minimum viable (MVP) ou une solution déployée.</li>
                               <li>Projets avec un potentiel de scalabilité et d’impact démontré.</li>
                               <li>Équipes prêtes à lever des fonds ou à s’étendre sur de nouveaux marchés.</li>
                             </ul>
                             <h4>Contenu du Programme :</h4>
                             <ol>
                               <li>Modules intensifs sur : <ul>
                                   <li>Stratégie de croissance et scalabilité.</li>
                                   <li>Accès au financement et levée de fonds.</li>
                                   <li>Branding et marketing avancés.</li>
                                   <li>Déploiement sur les marchés des LMICs.</li>
                                 </ul>
                               </li>
                               <li>Accès à un réseau d’investisseurs, de partenaires stratégiques et de mentors.</li>
                               <li>Démo Day pour présenter les solutions à des parties prenantes clés.</li>
                             </ol>
                             <h4>Durée :</h4>
                             <p class="p-classik">3 à 6 mois.</p>
                           </div>
                         </div>
                       </div>
                       <div class="accordion-item wow fadeInUp">
               ...
               <div class="tab-pane fade show service-detail" id="pills-projet" role="tabpanel" aria-labelledby="pills-projet-tab">
                 <div class="box-questions">
                   <!-- <h1 class="heading-ag-3xl mb-20"></h1> -->
                   <h4 class="heading-ag-lg dark-950 mb-30">Projets Pilotes</h4>
                   <div>
                     <img src="assets/imgs/pages/services/baner_2.jpg" alt="Kronik" />
                   </div>
                   <div class="service-detail">
                   <p class="p-classik">
    Avant de lancer une solution à grande échelle, il est essentiel de s'assurer de son 
    <strong>adéquation aux besoins réels</strong> des utilisateurs et du contexte dans lequel elle sera utilisée. 
    En collaborant avec des <strong>hôpitaux partenaires</strong>, nous bénéficions d'un environnement contrôlé 
    pour tester et affiner nos solutions en conditions réelles. Cette approche nous permet de recueillir des retours 
    précis des professionnels de santé et des patients, d'identifier les défis imprévus, et d'apporter les ajustements nécessaires. 
    Ainsi, nous garantissons que chaque solution déployée est adaptée aux réalités locales, maximisant son efficacité et son impact.
</p>

<p class="p-classik">
    Dans le cadre d'un <strong>projet pilote</strong>, nous avons testé un dispositif connecté pour le suivi 
    des patients diabétiques dans les zones rurales. Ce projet visait à résoudre le problème de 
    <strong>l'accès limité aux soins</strong> dans ces régions. Grâce à ces dispositifs, les patients pouvaient 
    mesurer leurs taux de glucose et partager les données en temps réel avec leurs médecins via une application dédiée. 
    Les résultats ont montré une <strong>amélioration significative</strong> de la gestion des maladies, avec une réduction 
    des complications liées au diabète et une meilleure adhérence au traitement.
</p>

  
  <h3>Principaux Avantages de Notre Approche</h3>
<div class="row">
  <div class="col-md-6">
    <ul>
      <li>Tests en conditions réelles avec des hôpitaux partenaires.</li>
      <li>Recueil de retours détaillés des professionnels de santé.</li>
      <li>Identification et résolution des défis imprévus.</li>
      <li>Adaptation aux réalités locales pour maximiser l'efficacité.</li>
      <li>Amélioration de la gestion des soins grâce aux données connectées.</li>
    </ul>
  </div>
  <div class="col-md-6">
    <ul>
      <li>Réduction des complications liées aux maladies chroniques.</li>
      <li>Optimisation de l'accès aux soins dans les zones rurales.</li>
      <li>Suivi médical en temps réel pour une meilleure adhérence aux traitements.</li>
      <li>Renforcement de la collaboration entre patients et médecins.</li>
      <li>Validation des solutions avant leur déploiement à grande échelle.</li>
    </ul>
  </div>
</div>
</div>
               ...
               <div class="tab-pane fade show service-detail" id="pills-formation" role="tabpanel" aria-labelledby="pills-formation-tab">
               <div class="box-questions">
                   <!-- <h1 class="heading-ag-3xl mb-20"></h1> -->
                   <h4 class="heading-ag-lg dark-950 mb-30">Formation et Ressources</h4>
                   <div>
                     <img src="assets/imgs/pages/services/baner3.jpg" alt="Kronik" />
                   </div>
                   <div class="service-detail">
                   <p class="p-classik"> Dans un monde où les technologies évoluent rapidement, la <strong>formation</strong> est un levier indispensable pour aider les innovateurs à transformer leurs idées en solutions concrètes. Nos modules de formation spécialisés abordent des thèmes clés comme la <strong>santé numérique</strong>, l’<strong>intelligence artificielle</strong> et la <strong>réglementation</strong>, offrant ainsi des outils pour naviguer efficacement dans un écosystème en constante évolution. Ces thématiques, soigneusement choisies, répondent aux besoins actuels des secteurs technologiques et médicaux. </p> <p class="p-classik"> En complément de la théorie, nos formations mettent l’accent sur le <strong>développement de compétences pratiques</strong>. À travers des études de cas, des ateliers interactifs et l’intervention d’experts, les participants apprennent à résoudre des défis réels tout en renforçant leur vision stratégique. Cette approche immersive garantit une meilleure compréhension des contraintes technologiques et réglementaires, tout en favorisant l’émergence de solutions adaptées et impactantes. </p> 
</div>
</div>
  ...
  <div class="container" data-aos="fade-up">
    ...
    <p class="mb-4">
      Postulez pour rejoindre la première cohorte du Kronik Lab et révolutionner la prise en charge des maladies chroniques grâce à l’innovation numérique.
    </p>
    <div class="row">
        ...
        <div class="form-contact-us">
          <form action="#">
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <textarea class="form-control" rows="3" placeholder="Problématique ciblée" required></textarea>
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
                  <textarea class="form-control" rows="3" placeholder="Solution proposée" required></textarea>
                </div>
              </div>
            </div>
            <div class="form-group">
              <select class="form-control" required>
                ...
                <option value="en-developpement">Produit en cours de développement</option>
                <option value="commercialise">Produit déjà commercialisé</option>
              </select>
            </div>
            ...
            <div class="row">
              <div class="col-md-6">
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Nom du porteur de projet" required />
                </div>
              </div>
              <div class="col-md-6">
                <div class="form-group">
            ...
            <div class="row">
              ...
              <div class="col-md-6">
                <div class="form-group">
                  <input type="text" class="form-control" placeholder="Organisation (le cas échéant)" />
                </div>
              </div>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
              <label>
                ...
                Je certifie que les informations fournies sont exactes et j'accepte les termes et conditions.
              </label>
            </div>
