...
<div class="row">
    <div class="col-lg-3">
        <div class="block-menu-left mb-30">
            <ul class="nav nav-pills flex-column" id="pills-tab" role="tablist">
                <li class="nav-item" role="presentation">
                    <a class="nav-link active" id="pills-business-tab" data-bs-toggle="pill" href="#pills-business" role="tab" aria-controls="pills-business" aria-selected="true">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="pills-strategy-tab" data-bs-toggle="pill" href="#pills-strategy" role="tab" aria-controls="pills-strategy" aria-selected="false">
                ...
                <li class="nav-item" role="presentation">
                    <a class="nav-link" id="pills-financial-tab" data-bs-toggle="pill" href="#pills-financial" role="tab" aria-controls="pills-financial" aria-selected="false">
        ...
        <div class="sidebar-brochure">
                            <h4 class="sub-heading-ag-xl title-line-bottom">Brochure</h4>
                            <p class="paragraph-rubik-m">when an unknown printer took galley offer typey anddey.</p>
    ...
    <div class="col-lg-9">
        <div class="tab-content" id="pills-tabContent">
            <div class="tab-pane fade show active service-detail" id="pills-business" role="tabpanel" aria-labelledby="pills-business-tab">
            <div class="service-detail">
                            <h1 class="heading-ag-3xl mb-20">UI/UX Design</h1>
                            ...
                            <div>
                                <img src="assets/imgs/pages/services/img.png" alt="Kronik" />
                            </div>
                            <h3>Plan Benefits</h3>
                            <div class="row">
                                <div class="col-md-6">
                        ...
                        <div class="box-questions">
                            <h4 class="heading-ag-lg dark-950 mb-30">Questions? You’re covered.</h4>
                                ...
                                <div class="accordion" id="accordionFAQ">
                                    <div class="accordion-item wow fadeInUp">
                                        ...
                                        <div class="accordion-collapse collapse show" id="collapseOne" aria-labelledby="headingOne" data-bs-parent="#accordionFAQ">
                                            <div class="accordion-body">Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis. Augue eu vulputate egestas cursus as vivamus. Commodo dictum ultrices nunc dignissim.</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item wow fadeInUp">
                                    ...
                                    <div class="accordion-item wow fadeInUp">
                                        <h5 class="accordion-header" id="headingFour">
                                            <button class="accordion-button text-heading-5 collapsed text-heading-5 type=" data-bs-toggle="collapse" data-bs-target="#collapseFour" aria-expanded="false" aria-controls="collapseFour">
            ...
            <div class="tab-pane fade service-detail" id="pills-strategy" role="tabpanel" aria-labelledby="pills-strategy-tab">
                <div class="service-detail">
                            <h1 class="heading-ag-3xl mb-20">Tax Strategy</h1>
                            <p>Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis.</p>
                            <p>Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis. Augue eu vulputate tortor egestas cursus vivamus. Commodo dictum iaculis eget massa phasellus ultrices nunc dignissim. Id nulla amet tincidunt urna sed massa sed. Pellentesque imperdiet proin aliquam nisl nulla. In donec massa ultrices amet eget. Tristique sed purus et maecenas condimentu purus lectus diam diam tellus libero id sapien justo.</p>
                            <p>Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis. Augue eu vulputate egestas cursus vivamus. Commodo dictum iaculis eget massa phasellus ultrices nunc dignissim.</p>
                            <div>
            ...
            <div class="tab-pane fade" id="pills-financial" role="tabpanel" aria-labelledby="pills-financial-tab">
                <div class="service-detail">
                            <h1 class="heading-ag-3xl mb-20">Financial Advisory</h1>
                            <p>Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis.</p>
                            <p>Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis. Augue eu vulputate tortor egestas cursus vivamus. Commodo dictum iaculis eget massa phasellus ultrices nunc dignissim. Id nulla amet tincidunt urna sed massa sed. Pellentesque imperdiet proin aliquam nisl nulla. In donec massa ultrices amet eget. Tristique sed purus et maecenas condimentu purus lectus diam diam tellus libero id sapien justo.</p>
                            <p>Lorem ipsum dolor sit amet consectetur. Ut tellus suspendisse nulla aliquam. Risus rutrum tellus eget ultrices pretium nisi amet facilisis. Augue eu vulputate egestas cursus vivamus. Commodo dictum iaculis eget massa phasellus ultrices nunc dignissim.</p>
                            <div>
