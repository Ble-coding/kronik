<section class="position-relative overflow-hidden box-section box-meet-experts">
    ...
    <div class="banner-small-title-black line-primary-home">Rencontrez Notre Équipe</div>
    <h2 class="heading-ag-3xl dark-950">
        Construire des Solutions <br class="d-none d-lg-block" />
        Ensemble
    </h2>
</div>
<div class="col-lg-5 mb-30" data-aos="fade-up">
    <p class="paragraph-rubik-r">
        Avec des décennies d’expérience et une vision commune, nous bâtissons un futur où la gestion des maladies chroniques est accessible, efficace et équitable pour tous.
    </p>
</div>
                        ...
                        <div class="card-expert">
                            ...
                            <div class="card-info">
                                ...
                                <div class="card-text-info">
                                    <a href="#" class="sub-heading-ag-xl neutral-1200">Kouadio Yao Séraphin
                                    </a>
                                    <p class="paragraph-rubik-r grey-800">Directeur Général</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="card-expert">
                            ...
                            <div class="card-info">
                                ...
                                <div class="card-text-info">
                                    <a href="#" class="sub-heading-ag-xl neutral-1200">Koné Awa Fatous</a>
                                    <p class="paragraph-rubik-r grey-800">Responsable des Programmes d’Incubation</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-6">
                        <div class="card-expert">
                            ...
                            <div class="card-info">
                                ...
                                <div class="card-text-info">
                                    <a href="#" class="sub-heading-ag-xl neutral-1200">Traoré Aboubacar</a>
                                    <p class="paragraph-rubik-r grey-800">Directeur Technique (CTO)</p>
                                </div>
                            </div>
                        </div>
                    </div>
