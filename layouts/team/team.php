...
// Fonction pour générer les URLs avec des paramètres existants
function generateUrl($route, $params = []) {
    ...
    return $route . '?' . http_build_query($updatedParams);
}
?>
    ...
    <div class="container" data-aos="fade-up">
        <div class="row align-items-end">
            <div class="col-lg-7 mb-30" data-aos="fade-up">
                <div class="banner-small-title-black line-primary-home">
                    <?= htmlspecialchars($team_translations['meet_team']) ?>
                </div>
