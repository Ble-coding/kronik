...
$pageTitle = htmlspecialchars($translations['error']['title'] ?? 'Titre par défaut');
$pageDescription = htmlspecialchars($translations['error']['description'] ?? 'Description par défaut');
$heading = htmlspecialchars($translations['error']['message'] ?? 'Message par défaut');
$details = htmlspecialchars($translations['error']['details'] ?? 'Détails par défaut');
$buttonText = htmlspecialchars($translations['error']['button'] ?? 'Retour au formulaire');
