...
<body>
    ...
    <main>
        ...
        <!--Home 5 Section 1-->
        <?php
                require __DIR__ . '/layouts/home/slide.php';
            ?>

      <!--Home 5 Section 4 -->
      <?php
                require __DIR__ . '/layouts/home/about.php';
            ?>

            
        <?php
                require __DIR__ . '/layouts/home/formation.php';
            ?>

  

        <?php
                require __DIR__ . '/layouts/home/lmics.php';
            ?>
        <!--Home 5 Section 2 -->
        ...
        <!--Home 5 Section 3 -->
        <?php
                require __DIR__ . '/layouts/home/programmes.php';
            ?>
        ...
        <!--Home 5 Section 6 -->
        <?php
                require __DIR__ . '/layouts/home/stat.php';
            ?>

        <!--Home 5 Section 3 -->
        <?php
                require __DIR__ . '/layouts/home/gallery.php';
            ?>
